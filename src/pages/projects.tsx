  ...
  return (
    <div className="projects-page">
      ...
      <style jsx>{`
        ...
        .back-button, .back-button:visited, .menu a, .menu a:visited { color: var(--text-primary) !important; text-decoration: none !important; font-size: .8rem; font-weight: 700; }.back-button { padding: 5px 0; }.back-button:hover, .menu a:hover, .menu a.active { color: var(--accent) !important; }
